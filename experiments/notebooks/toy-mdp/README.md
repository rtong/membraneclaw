...
| # | File | Covers | Colab |
| --- | --- | --- | --- |
| 01 | `01_finite_mdp.ipynb` | finite MDPs; states, actions, transitions, rewards, terminal states; MDP diagram and transition matrices | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/bayanasar/membraneclaw/blob/main/experiments/notebooks/toy-mdp/01_finite_mdp.ipynb) |
| 02 | `02_bellman_value_iteration.ipynb` | Bellman expectation and optimality equations; value iteration; policy extraction | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/bayanasar/membraneclaw/blob/main/experiments/notebooks/toy-mdp/02_bellman_value_iteration.ipynb) |
| 03 | `03_monte_carlo.ipynb` | Monte Carlo policy evaluation from sampled episodes | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/bayanasar/membraneclaw/blob/main/experiments/notebooks/toy-mdp/03_monte_carlo.ipynb) |
| 04 | `04_reinforce_baseline.ipynb` | REINFORCE; variance reduction with a baseline and a learned critic | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/bayanasar/membraneclaw/blob/main/experiments/notebooks/toy-mdp/04_reinforce_baseline.ipynb) |
| 05 | `05_ppo_clipping.ipynb` | PPO's probability ratio and clipping behaviour | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/bayanasar/membraneclaw/blob/main/experiments/notebooks/toy-mdp/05_ppo_clipping.ipynb) |
